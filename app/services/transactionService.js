/**
 * Transaction Service - Pure business logic for transaction lifecycle management
 * Following SRP: Only handles transaction state and flow logic, no UI dependencies
 */
 ...
 */
export function determineTransactionPhase(states) {
    const {
        isSimulateLoading,
        isSimulateSuccess,
        isSimulateError,
 ...
 */
export function isTransactionLoading(phase) {
    return [
 ...
 */
export function getTransactionButtonText(phase, defaultText) {
    switch (phase) {
 ...
 */
export function createTransactionExecutor(params) {
